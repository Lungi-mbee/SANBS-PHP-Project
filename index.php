        ...
        <div class="panel left-panel">
          <div class="content">
            ...
            <p>
             ...
             what you consider less is someone
             else’s more, </br>be the reason someone
              smiles or more so survives !!</br> so go ahead and join
            </p>
            <button class="btn transparent" id="sign-up-btn">
              Sign up
            </button>
          </div>
          <img src="img2/log.png" class="image" alt="" />
        </div>
        <div class="panel right-panel">
          <div class="content">
            <h3>One of us ?</h3>
            <p>
              Welcome Back Home !! Ready to save lives </br> Let's GOOOO !!
            </p>
            <button class="btn transparent" id="sign-in-btn">
              Sign in
            </button>
          </div>
          <img src="img2/register.png" class="image" alt="" />
        </div>
      </div>
    </div>
